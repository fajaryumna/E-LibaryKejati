            ...
            <div class="create-main">
                ...
                <form class="entri" action="{{ route('update_peminjaman', $p->id) }}" method="POST"
                    ...
                    <div class="mb-2 d-flex">
                        ...
                        <input type="text" name="judul" class="form-control entri" id="judul"
                            value="{{ $p->judul }}" disabled>
                    </div>
                    <div class="mb-2 d-flex">
                        <label for="nama_pengarang" class="form-label">Nama Peminjam</label>
                        <input type="text" name="nama" class="form-control entri" id=""
                    ...
                    <div class="mb-2 d-flex">
                        <a href="/data_peminjaman" style="width:18%;">
                            <button class="btn"
                                style="width:100%; background-color: #d9d9d9; font-size: small;">Kembali</button>
                        </a>
                        <button type="submit" class="btn"
                            style="width:80%; background-color: #067321; color: white; font-size: small;">Simpan Data
                            Peminjaman</button>
